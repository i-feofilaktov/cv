...
\begin{document}
    ...
    \section{Work Experience}
        ...
        Leading team of engineers tasked with providing regression and acceptance tests in production-like environment for advertising backend service.
		\begin{itemize}
			\item Designed the infarstructure for continuous delivery for testing stages of microservices, which helped to split monolith application into several microservices.
