...
\address{Tumanyan st, 28/20}{Armenia, Yerevan}
...
\begin{document}
    ...
    \section{Work Experience}
        ...
        Led team of QA engineers tasked with providing regression and acceptance tests in production-like environment for advertising backend service.
		\begin{itemize}
    ...
    \section{Skills}{
        \cvcomputer{Testing tools}{pytest, allure}{VCS}{git, mercurial, Yandex internal VSC}
