...
\begin{document}
    ...
    \section{Work Experience}
        ...
        Leading team of engineers tasked with providing reliable infrastructure for regression and acceptance tests in production-like environment for advertising backend service.
		\begin{itemize}
			\item Designed the continuous delivery process for standalone microservices, which helped to split monolith application into several microservices.
            \item Decreased service downtime by 20\% by organizing on-call duty process.
            \item Reduced resource utilization of the testing process by 30\% via various optimizations.
            \item Performed capacity planning and resource management for the infrastructure.
        \end{itemize}
    }
