...
\begin{document}
    ...
    \section{Work Experience}
        ...
        Led team of QA engineers tasked with providing regression and acceptance tests in production-like environment for adverising backend service.
		\begin{itemize}
		...
		\begin{itemize}
			...
			\item Automated routine tasks such as parsing WEB-pages to organize data for easier analysis in MS Word
